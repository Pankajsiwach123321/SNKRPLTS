...
function opentabs(Tabid) {
    ...
    const activetab = document.querySelector(`button[onclick="opentabs('${Tabid}')"]`)
...
function openproduct(Productid) {
    ...
    const activenumber = document.querySelector(`button[onclick="openproduct('${Productid}')"]`)
...
function myshowes(colorId) {
    ...
    const activecolor = document.querySelector(`div[onclick="myshowes('${colorId}')"]`)
